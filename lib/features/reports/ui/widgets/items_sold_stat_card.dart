...
class ItemsSoldStatCard extends StatelessWidget {
  const ItemsSoldStatCard({super.key});
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'across 86 ${l10n.stockKeepingUnits}',
              style: isDark ? AppStyles.statUnitDark : AppStyles.statUnitLight,
            ),
            const Spacer(),
            StatChangeBadge(label: '+8.2%', color: accent),
          ],
        ),
      ),
    );
